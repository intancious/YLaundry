...
if (empty($this->session->userdata['level'])) {
    ...
    if ($this->session->userdata['user'] == "kasir" and "kurir") {
        $master = "";
        $laporan = "hidden";
    } else {
        $master = "";
...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= site_url('beranda/p/beranda') ?>" style="text-transform: uppercase;">Sistem Manajemen Laundry Semi online</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?= $master; ?>>
                        ...
                        <ul class="ml-menu">
                            <li><a href="<?= site_url('kasir/p/data')  ?>">Kasir</a></li>
                            <li><a href="<?= site_url('konsumen/p/data')  ?>">Konsumen</a></li>
                            <li><a href="<?= site_url('paket/p/data')  ?>">Paket</a></li>
                            <li><a href="<?= site_url('transaksi/p/data')  ?>">Transaksi</a></li>
                        </ul>
                    </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2020 <a href="javascript:void(0);">Intan Permatasari-PLJ_TIF_POLIJE</a>.
                </div>
            </div>
            <!-- #Footer -->
        </aside>
